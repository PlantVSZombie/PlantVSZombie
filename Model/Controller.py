...
class Controller():
    ...
    def initiate(self):
        ...
        while True:
            ...
            self.dealCardSelected(mos_pos, mos_click, self.menu, self.screen)  # 调用Controller类的管理函数
    ...
    '''判断卡片是否被选择并且做出相应动作
        传参：鼠标位置，鼠标点击，菜单实例
    '''
    def dealCardSelected(self,mos_pos, mos_click, menu, surface):
    ...
    '''选择植物将要种植时的处理'''
    def dealSow(self):
        (click, _, _) = pygame.mouse.get_pressed()  # 监听是否再次点击，如果再点击就要种植物了
